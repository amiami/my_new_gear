    ...
    >
      ...
      >
        <h2 id="publish-dialog-title" className="text-xl font-bold text-white">
          {isSharing ? "公開してXでシェアしますか？" : "このガジェットを公開しますか？"}
        </h2>
        <p
        ...
        <div className="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isSubmitting}
            className="min-h-11 rounded-lg bg-white px-4 text-sm font-semibold text-neutral-950 hover:bg-neutral-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:cursor-wait disabled:opacity-60"
          >
            {isSubmitting
              ? "公開しています…"
              : isSharing
